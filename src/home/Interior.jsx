...
import logoDark from "../assets/images/logo/logo-all-dark.png";
...
import featuredImg from "../assets/images/featured/featured-01.jpg";
                  ...
                  <div className="col-lg-8">
                    <div className="feature-area">
                      ...
                      <h3 className="title mt--20 fontWeight500 lineheight--1-8">
                        ...
                        yours. We can be design yours house so dont woory you
                        can hire us. Beautiful and hand made design we can be
                        create.
                      </h3>
                    </div>
                  </div>
                ...
                <div className="col-lg-12 col-xl-6 mt_lg--50 mt_md--30 mt_sm--30">
                  <div className="content">
                    <p className="subtitle">
                      <span>Modern</span> Design For Interior
                    </p>
                    <h2 className="fontWeight500">
                      Provide a Modern Design For Your Home and Office
                    </h2>
                    <p>
                      Uniq interior design provide for your home. you can be
                      create as you like. Our modern designer provide as you are
                      like. A interior designer can build your design and
                      fullfile your demand.Uniq interior design provide for your
                      home. you can be create as you like. Our modern designer
                      provide as you are like. A interior designer can build
                      your design and fullfile your demand
                    </p>
